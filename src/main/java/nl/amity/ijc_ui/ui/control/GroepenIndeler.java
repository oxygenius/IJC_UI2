...
public class GroepenIndeler implements GroepenIndelerInterface {
    ...
    /* (non-Javadoc)
	 * @see nl.amity.ijc_ui.ui.control.GroepenIndelerInterface#maakGroepsindeling(nl.amity.ijc_ui.data.groepen.Groepen)
	 */
    //@Override
    ...
    /* (non-Javadoc)
	 * @see nl.amity.ijc_ui.ui.control.GroepenIndelerInterface#maakGroepsindeling(nl.amity.ijc_ui.data.groepen.Groepen, nl.amity.ijc_ui.data.groepen.Groepen, int)
	 */
    @Override
...
//        for (int i = 0; i < groepen.size() - 1; ++i) {
    ...
    /* (non-Javadoc)
	 * @see nl.amity.ijc_ui.ui.control.GroepenIndelerInterface#maakWedstrijdschema(nl.amity.ijc_ui.data.groepen.Groepen)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see nl.amity.ijc_ui.ui.control.GroepenIndelerInterface#updateWedstrijdschema(nl.amity.ijc_ui.data.wedstrijden.Wedstrijden, nl.amity.ijc_ui.data.groepen.Groepen, int)
	 */
    @Override
