...
public interface GroepenIndelerInterface {
	...
	/**
	 * Werk de groepsindeling van ��n groep bij voordat de wedstrijden worden bepaald. Spelers die afwezig zijn, worden 
	...
	/**
	 * Update wedstrijden voor ��n groep. Wedstrijden voor alle andere groepen blijven
	 * ongewijzigd.
